...
def main():
    ...
    type_of_meal_plan = st.radio('type_of_meal_plan', ['Not Selected','Meal Plan 1', 'Meal Plan 2', 'Meal Plan 3'])
    required_car_parking_space = st.radio('required_car_parking_space', ['Yes','No'])
    room_type_reserved = st.radio('room_type_reserved', ['Room_Type 1','Room_Type 2', 'Room_Type 3', 'Room_Type 4', 'Room_Type 5', 'Room_Type 6', 'Room_Type 7'])
    ...
    market_segment_type = st.radio('market_segment_type', ['Online','Offline', 'Corporate', 'Complementary', 'Aviation'])
    repeated_guest = st.radio('repeated_guest', ['Yes','No'])
